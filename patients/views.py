...
class SendSOS(APIView):
    ...
    def post(self, request, username):
        ...
        try:
            ...
            return Response({'message': f'Failed to send SOS message: {str(e)}'},
        ...
        try:
            ...
            return Response(
                {'message': 'Patient created successfully',
                 'data': {'user_name': response.user_name, 'id': response.id}},
...
class PatientResource(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            serializer.save()
            return Response({'message': 'Patient created successfully', 'data': serializer.data},
                            status=status.HTTP_201_CREATED)
        return Response({'message': 'Error creating patient', 'errors': serializer.errors},
                        status=status.HTTP_400_BAD_REQUEST)
    ...
    def put(self, request, username):
        ...
        if serializer.is_valid():
            ...
            return Response({'message': 'Patient updated successfully', 'data': serializer.data},
                            status=status.HTTP_200_OK)
        return Response({'message': 'Error updating patient', 'errors': serializer.errors},
                        status=status.HTTP_400_BAD_REQUEST)
...
class RecordView(APIView):
    def post(self, request):
        ...
        try:
            ...
            return Response({'message': 'Record created successfully', 'data': record.id},
                            status=status.HTTP_201_CREATED)
        except Exception as e:
